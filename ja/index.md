...
## ダウンロード
バージョン 5.7.4 | 2022-06-11 | <a href="ReleaseNotes" target="_blank">リリースノート</a>
<br/><br/>[![Download](macOS/DownloadOnTheMacAppStore.svg)](macappstores://itunes.apple.com/app/id1378587993)


## 購入
- 「2週間のトライアル」アプリ内購入を購入すると、2週間のトライアルライセンスを無料で取得できます(Appleアカウントのログインが必要です)。これはサブスクリプションではないため、試用後、自動的に更新されることはありません。
- あなたはあなたの試用期間中にアプリのすべての機能を楽しむことができます。
- 試用後、アプリはロックされ、使用し続けるには生涯ライセンスである「フルアプリ」ワンタイムアプリ内購入を購入する必要があります。
